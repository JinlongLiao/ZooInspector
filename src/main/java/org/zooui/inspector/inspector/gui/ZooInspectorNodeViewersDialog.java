...
import org.zooui.inspector.inspector.manager.ZooInspectorManager;
...
public class ZooInspectorNodeViewersDialog extends JDialog implements ListSelectionListener {
    private static final Logger logger = LoggerFactory.getLogger(ZooInspectorNodeViewersDialog.class);
