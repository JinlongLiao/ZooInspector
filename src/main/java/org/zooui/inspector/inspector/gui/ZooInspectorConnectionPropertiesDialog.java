...
import org.zooui.inspector.inspector.manager.Pair;
...
public class ZooInspectorConnectionPropertiesDialog extends JDialog {
    private static final Logger logger = LoggerFactory.getLogger(ZooInspectorConnectionPropertiesDialog.class);
