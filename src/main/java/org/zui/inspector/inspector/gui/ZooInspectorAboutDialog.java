...
public class ZooInspectorAboutDialog extends JDialog {
    private static final Logger logger = LoggerFactory.getLogger(ZooInspectorAboutDialog.class);
    ...
    public ZooInspectorAboutDialog(Frame frame) {
        ...
        try {
            java.net.URL aboutURL = new File(FileUtil.appendRootPath("/about.html")).toURI().toURL();
